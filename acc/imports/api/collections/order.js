...
export const Order = new Mongo.Collection("acc_order");
    ...
    customerId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                ...
                optionsMethod: 'acc.selectOptMethods.customer',
...
Meteor.startup(function () {
    Order.itemsSchema.i18n("acc.order.schema");
    Order.schema.i18n("acc.order.schema");
