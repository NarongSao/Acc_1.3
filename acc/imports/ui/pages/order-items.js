...
// Declare template
var itemsTmpl = Template.Acc_orderItems,
    actionItemsTmpl = Template.Acc_orderItemsAction,
    editItemsTmpl = Template.Acc_orderItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'acc.order.schema';
...
itemsTmpl.events({
    ...
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection,
            {_id: this._id},
            {title: TAPi18n.__('acc.order.schema.itemId.label'), itemTitle: this.itemId}
        );
    }
});
