...
// Declare template
let formTmpl = Template.Acc_customerReport,
    genTmpl = Template.Acc_customerReportGen;
...
let hooksObject = {
    ...
    onSuccess: function (formType, result) {
        ...
        let path = FlowRouter.path("acc.customerReportGen", params, queryParams);
...
AutoForm.addHooks('Acc_customerReport', hooksObject);
